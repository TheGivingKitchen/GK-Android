...
import kotlinx.android.synthetic.main.view_resource_provider_index.view.*
import org.givingkitchen.android.R

class ResourceProviderIndexView @JvmOverloads constructor(var items: MutableList<Any>, context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : LinearLayout(context, attrs, defStyle) {
    ...
    init {
        ...
        val adapter = ResourceProviderIndexAdapter(items)
